from termproject_olympic.olympics_engine.core import OlympicsBase
from termproject_olympic.olympics_engine.viewer import Viewer, debug
from termproject_olympic.olympics_engine.objects import Ball, Agent
...
from termproject_olympic.olympics_engine.tools.settings import COLORS, COLOR_TO_IDX, IDX_TO_COLOR

grid_node_width = 2     #for view drawing
grid_node_height = 2

from termproject_olympic.olympics_engine.tools.func import closest_point, distance_to_line
