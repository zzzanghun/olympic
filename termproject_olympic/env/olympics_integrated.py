...
from termproject_olympic.olympics_engine.AI_olympics import AI_Olympics

from termproject_olympic.utils.box import Box
from termproject_olympic.env.simulators.game import Game

import numpy as np

class OlympicsIntegrated(Game):
    def __init__(self, conf, seed=None, game_name="olympic-integrated"):
        ...
        self.env_core = AI_Olympics(random_selection = True, minimap = False, game_name=game_name)
